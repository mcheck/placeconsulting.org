...
FCKeditor.prototype._GetIFrameHtml = function()
{
	...
	return '<iframe class="' + this.InstanceName + '-frame" id="' + this.InstanceName + '___Frame" src="' + sLink + '" width="' + this.Width + '" height="' + this.Height + '" frameborder="0" scrolling="no"></iframe>' ;
}
